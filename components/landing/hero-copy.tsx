...
export function HeroCopy() {
  return (
    <div className="max-w-3xl self-center text-white">
      <p className="mb-6 text-sm font-bold uppercase tracking-[.18em] text-[#D9C7FF]">
      ...
      <div className="mt-9 flex flex-wrap gap-3">
        <Link href="/teacher" className="rounded-[24px] bg-brand px-7 py-3.5 text-sm font-bold text-white shadow-lg shadow-black/20">
          ดู Teacher Dashboard
        </Link>
        <Link href="/learn" className="rounded-[24px] border border-white/40 bg-white/10 px-7 py-3.5 text-sm font-bold text-white backdrop-blur">
          ทดลองมุมมองผู้เรียน
        </Link>
      </div>
    </div>
