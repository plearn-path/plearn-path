...
export function RecommendedActionCard() {
  ...
  return (
    <aside className="rounded-[28px] bg-brand p-7 text-white shadow-sm">
      ...
      <button onClick={() => setCreated(true)} className="mt-7 rounded-[24px] bg-white px-4 py-3 text-sm font-bold text-plum-deep">
        {buttonLabel}
      </button>
